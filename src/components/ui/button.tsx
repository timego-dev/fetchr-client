...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-primary-950 dark:focus-visible:ring-primary-300",
  {
    variants: {
      variant: {
        default:
          "bg-primary-500 text-white hover:bg-primary-900/90 hover:text-white dark:bg-primary-50 dark:text-primary-900 dark:hover:bg-primary-50/90",
        destructive:
      ...
      size: {
        default: "px-6 py-2.5 text-[14px] leading-[20px]",
